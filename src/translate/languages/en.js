const messages = {
  en: {
    translations: {
      ...
      cardTestHome: {
        pTest:
          "Your testimonial will appear almost in real time after sending. Choose your best words, be kind and respectful! The Rocket Moon loves you too. 💜",
      },
      pageSeeJobs: {
      ...
      pageProfile: {
        ...
        h2YourJobs: "👇🏼 Your jobs on the road",
        h2Testimonials: "👌🏽 Your testimonials",
      },
      cardTestDetail: {
        pTest:
          "Your testimonial will appear almost in real time after sending. Choose your best words, be kind and respectful! The Rocket Moon loves you too. 💜",
      ...
      cardCreateJob: {
        pPost: "Post a job",
        pGamer: "🚀 You are 3 fields away to get a Professional Gamer!",
